        ...
        <div className="min-h-screen bg-[#0D0D0D] text-[#E8E8E8] flex items-center justify-center animate-page-in">
            <div className="w-full max-w-md px-4">
                ...
                <div className="bg-[#1A1A1A] rounded-2xl p-8 border border-[#2A2A2A] animate-card-in">
                    <h2 className="text-2xl font-bold text-center mb-1 text-[#E8E8E8]">Create Account</h2>
                    <p className="text-[#888888] text-sm text-center mb-6">Join ArtifactLens today</p>
                    ...
                    {/* Success Message */}
                    {success && (
                        <div className="mb-5 p-3 rounded-xl bg-[#0F2D1A] border border-[#6EE7B7]/20 text-[#6EE7B7] text-sm text-center animate-pop-in">
                    ...
                    <p className="mt-6 text-center text-sm text-[#888888]">
                        ...
                        <Link to="/login" className="text-[#A78BFA] font-semibold hover:text-[#8B5CF6] transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
